...
public class MessagePacket extends Packet {
    ...
    public MessagePacket(int cmd, ByteString requestBody) {
    ...
    public MessagePacket(int cmd, int seq, String content) {
        this.cmd = cmd;
        this.seq = seq;
    ...
    public static MessagePacket build(BufferedSource reader) throws IOException {
